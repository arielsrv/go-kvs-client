...
require (
	github.com/arielsrv/go-kvs-client v1.3.6
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.21.6 // indirect
	...
	github.com/eko/gocache/store/freecache/v4 v4.2.10 // indirect

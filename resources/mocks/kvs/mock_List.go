...
func (_m *MockList) Add(item *kvs.Item) {
	_m.Called(item)
}
...
func (_c *MockList_All_Call) Return(_a0 iter.Seq[*kvs.Item]) *MockList_All_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *MockList_Len_Call) Return(_a0 int) *MockList_Len_Call {
	_c.Call.Return(_a0)
	return _c
}

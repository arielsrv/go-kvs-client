...
func (_c *MockAWSClient_BatchGetItem_Call) Return(batchGetItemOutput *dynamodb.BatchGetItemOutput, err error) *MockAWSClient_BatchGetItem_Call {
	_c.Call.Return(batchGetItemOutput, err)
	return _c
}

func (_c *MockAWSClient_BatchGetItem_Call) RunAndReturn(run func(ctx context.Context, params *dynamodb.BatchGetItemInput, optFns ...func(*dynamodb.Options)) (*dynamodb.BatchGetItemOutput, error)) *MockAWSClient_BatchGetItem_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAWSClient_BatchWriteItem_Call) Return(batchWriteItemOutput *dynamodb.BatchWriteItemOutput, err error) *MockAWSClient_BatchWriteItem_Call {
	_c.Call.Return(batchWriteItemOutput, err)
	return _c
}

func (_c *MockAWSClient_BatchWriteItem_Call) RunAndReturn(run func(ctx context.Context, params *dynamodb.BatchWriteItemInput, optFns ...func(*dynamodb.Options)) (*dynamodb.BatchWriteItemOutput, error)) *MockAWSClient_BatchWriteItem_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAWSClient_GetItem_Call) Return(getItemOutput *dynamodb.GetItemOutput, err error) *MockAWSClient_GetItem_Call {
	_c.Call.Return(getItemOutput, err)
	return _c
}

func (_c *MockAWSClient_GetItem_Call) RunAndReturn(run func(ctx context.Context, params *dynamodb.GetItemInput, optFns ...func(*dynamodb.Options)) (*dynamodb.GetItemOutput, error)) *MockAWSClient_GetItem_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockAWSClient_PutItem_Call) Return(putItemOutput *dynamodb.PutItemOutput, err error) *MockAWSClient_PutItem_Call {
	_c.Call.Return(putItemOutput, err)
	return _c
}

func (_c *MockAWSClient_PutItem_Call) RunAndReturn(run func(ctx context.Context, params *dynamodb.PutItemInput, optFns ...func(*dynamodb.Options)) (*dynamodb.PutItemOutput, error)) *MockAWSClient_PutItem_Call {
	_c.Call.Return(run)
	return _c
}
